...
public class SaveNewInventory {
    public static void SaveNewInventory(boolean isEdit, JTextField tfItemCode, 
            JComboBox<String> selectedItemCode, JTextField tfItemName, 
        ...
        if ((!isEdit && tfItemCode.getText().trim().isEmpty()) ||
            ...
            itemName.trim().isEmpty() || selectedItemCode.getSelectedItem().toString().equals("Please Select") || 
        ...
        if (!validate.validateID(itemCode, "ppe.txt") || (!isEdit && !validate.validateQuantity(quantity)) || 
